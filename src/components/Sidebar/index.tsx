...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "/admin/home/security/profileaccess",
      },
      {
        icon: (
          <svg
        ...
        label: "Users",
        route: "/admin/home/security/users",
      },
      {
        icon: (
          <svg
        ...
        route: "#",
        children: [
          { label: "All Users", route: "/admin/home/security/staff/all" },
          { label: "Profile Users", route: "/admin/home/security/staff/profile" },
        ],
      },
      {
        icon: (
        ...
        >
          ...
          <rect x="2" y="13" width="3" height="3" rx="0.5" fill="currentColor" />

          <rect x="6" y="3.5" width="10" height="1.5" rx="0.5" fill="currentColor" />
          <rect x="6" y="8.5" width="10" height="1.5" rx="0.5" fill="currentColor" />
          <rect x="6" y="13.5" width="10" height="1.5" rx="0.5" fill="currentColor" />
        </svg>
        ),
        label: "Task",
        route: "/admin/home/security/task",
      },
      {
        icon: (
          <svg
        ...
        label: "Calendar",
        route: "/admin/home/security/calendar",
      },

      {
        ...
        label: "Settings",
        route: "/admin/home/security/settings",
      },
    ],
  },
  {
          ...
          <Link href="/">
            ...
            />
             ...
             <Image
                ...
                priority
              />
            <h1 className="text-meta-3" style={{ marginLeft: '75px', marginTop: '-45px', fontWeight: 'bold', fontSize:'1.2em' }}>
              CEVETCO
            </h1>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                <h3 className="mb-4 ml-4 text-sm font-semibold text-meta-3">
                  {group.name}
                </h3>
